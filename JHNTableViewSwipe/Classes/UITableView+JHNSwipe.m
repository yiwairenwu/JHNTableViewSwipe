...
//           UIImage *image= [self.superview ClipToImageWithCGRect:CGRectMake(supperRect.origin.x, supperRect.origin.y<0?headRect.size.height: supperRect.origin.y+headRect.size.height, supperRect.size.width, supperRect.size.height-footRect.size.height+(supperRect.origin.y<0?supperRect.origin.y-headRect.size.height:-headRect.size.height))];
...
//           [imageView setFrame:CGRectMake(0, rect.origin.y, image.size.width, image.size.height)];
           ...
           UIView *btnBg = [[UIView alloc] initWithFrame:CGRectMake(rect.size.width-70, 0, 70, image.size.height-1)];
...
//    CGPoint originalOffset = self.contentOffset;
    ...
    CGRect headRect = [self rectForHeaderInSection:indexPath.section];
    CGRect footRect = [self rectForFooterInSection:indexPath.section];
    UIGraphicsBeginImageContextWithOptions((CGSizeMake(rect.size.width, rect.size.height-headRect.size.height-footRect.size.height)), NO, 0.0);
